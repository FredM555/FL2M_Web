...
-- Fonction 5 : get_appointments_needing_reminder
...
-- Fonction 11 : clean_old_logs (fonction de maintenance)
...
-- Vérification : Toutes les fonctions doivent maintenant avoir search_path défini
SELECT
...
-- =============================================================================
--
-- Les 11 fonctions ont maintenant search_path = public et sont protégées
-- contre les injections de schéma.
--
-- Alertes résolues : 11 alertes moyennes
--
-- =============================================================================
