...
const ModuleCandidats: React.FC = () => {
  ...
  // Code du service Module Candidats
  const moduleCode = 'PRCA';
  
  // Caractéristiques spécifiques au module Candidat
  const caracteristiques = [
    ...
    {
      titre: 'Développement Potentiel',
      description: 'Accompagnement personnalisé pour révéler et amplifier les talents.',
      icone: StarIcon
    },
    {
      titre: 'Projection Professionnelle',
      description: 'Stratégie de développement et d\'intégration professionnelle.',
      icone: GrowthIcon
    }
  ];
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Typography 
        ...
        fontWeight="bold"
      >
        Module Candidat : Déceler le Potentiel
      </Typography>
      ...
      >
        Un accompagnement stratégique pour identifier, développer 
        et intégrer les talents émergents dans votre organisation.
      </Typography>
      ...
      <Grid container spacing={4} sx={{ mb: 4 }}>
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body1" paragraph>
            ...
            - Évaluer les compétences et talents émergents
            - Construire des parcours de développement personnalisés
        ...
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body1" paragraph>
            - Évaluations de potentiel avancées
            - Entretiens de detection de talents
...
export default ModuleCandidats;