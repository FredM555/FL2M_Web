    ...
    <Box sx={{ width: '100%', position: 'relative', minHeight: '100vh' }}>
      ...
      <Box
        sx={{
          ...
          bottom: 0,
          zIndex: 0,
          backgroundImage: 'url(/images/ModuleCandidat.jpg)',
      ...
      >
        <Container maxWidth="lg">
          ...
          <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2 }}>
            ...
            <Tooltip title="Module Équipe" placement="right">
              <IconButton
              ...
              <Tooltip title="Module Associés" placement="left">
                <IconButton
