      ...
      <Grid container spacing={4} sx={{ mb: 4 }}>
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body1" paragraph>
            - Identifier et valoriser ses compétences individuelles
            - Renforcer sa contribution à l'équipe
        ...
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body1" paragraph>
            - Bilan de compétences individuelles
            - Coaching de développement personnel
            - Ateliers de communication d'équipe
