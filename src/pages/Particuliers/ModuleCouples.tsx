...
const ModuleCouples: React.FC = () => {
  ...
  const caracteristiques = [
    ...
    {
      titre: 'Harmonie relationnelle',
      description: 'Découvrez comment vos profils se complètent et créez un équilibre respectueux au sein du couple.',
      icone: FavoriteIcon
    }
  ];
    ...
    <Box sx={{ width: '100%', position: 'relative', minHeight: '100vh' }}>
      ...
      <Box
        sx={{
          ...
          bottom: 0,
          zIndex: 0,
          backgroundImage: 'url(/images/ModuleCouple.jpg)',
        ...
        <Container maxWidth="lg">
          ...
          <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 2, mb: 1 }}>
              <Tooltip title="Module Adultes" placement="right">
                <IconButton
        ...
        <Grid container spacing={4} sx={{ mb: 1 }}>
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="body1" paragraph sx={{ lineHeight: 1.7, color: 'text.secondary' }}>
              - Favoriser une communication claire et apaisée<br></br>
              - Comprendre les besoins et modes de fonctionnement de chacun<br></br>
              - Transformer les tensions en opportunités d’évolution<br></br>
              - Renforcer la complicité et la cohérence du couple<br></br>
            </Typography>
          </Grid>
          <Grid item xs={12} md={6}>
            <Typography variant="h5" gutterBottom sx={{ fontWeight: 600, color: '#1a1a2e', mb: 2 }}>
        ...
        <Box sx={{ textAlign: 'center' }}>
          {service && service.price === 9999 ? (
            <Button
              ...
              to="/contact?subject=Informations sur une prestation&module=Module Couples"
              sx={{
                px: 6,
                py: 2,
                fontSize: '1.1rem',
